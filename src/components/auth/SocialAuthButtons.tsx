  ...
  const handleAppleAuth = async () => {
    await handleAsyncError(
      async () => {
        ...
        throw new Error('Apple OAuth não implementado ainda');
      },
    ...
    <div className="space-y-3">
      <div className="relative">
        <div className="absolute inset-0 flex items-center">
          <span className="w-full border-t border-nuflow-mineral/20" />
        </div>
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white px-4 text-nuflow-mineral">
            Ou {actionText.toLowerCase()} com
          </span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-3">
        <Button
          ...
          className="w-full border-nuflow-mineral/30 hover:bg-nuflow-sand/50"

...
export const CouponsManagement: React.FC = () => {
  const { coupons, isLoading, toggleStatus, deleteCoupon, isToggling, isDeleting } = useCoupons();
  ...
  const handleToggleStatus = (coupon: Coupon) => {
    toggleStatus({ id: coupon.id, isActive: !coupon.is_active });
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-nuflow-charcoal">Gerenciar Cupons</h1>
          <p className="text-nuflow-mineral">Crie e gerencie cupons de desconto</p>
        </div>
        <Button 

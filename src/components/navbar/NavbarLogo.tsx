        ...
        <div className="flex items-center space-x-4">
          <div className="w-14 h-14 flex items-center justify-center transition-all duration-700 ease-out">
            <img 
              ...
              alt="NuFlow Logo" 
              className="w-10 h-10 object-contain transition-all duration-700 ease-out group-hover:scale-110"
            />
          </div>
          <div className="text-xl font-mono font-bold text-white uppercase tracking-[0.15em] transition-all duration-700 ease-out group-hover:text-trailflow-lighter">
            NUFLOW
          </div>
        </div>
      </Link>

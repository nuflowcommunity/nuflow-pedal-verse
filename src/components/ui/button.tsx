...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-trailflow-green focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 text-center relative overflow-hidden touch-manipulation",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-11 px-6 py-2.5 min-w-[140px] min-h-[44px]",
        sm: "h-9 rounded-md px-4 text-xs min-w-[120px] min-h-[36px]",
        lg: "h-12 rounded-lg px-8 text-base min-w-[160px] min-h-[48px]",
        xl: "h-14 rounded-lg px-10 text-lg min-w-[180px] min-h-[56px]",

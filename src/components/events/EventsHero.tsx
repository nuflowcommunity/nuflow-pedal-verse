...
const EventsHero = () => {
  return (
    <section className="bg-gradient-to-r from-nuflow-forest to-nuflow-darkForest py-16 md:py-24">
      <div className="container-custom text-white">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <Button 
              size="lg" 
              className="bg-nuflow-mint text-nuflow-forest hover:bg-nuflow-emerald hover:text-nuflow-darkForest transition-all"
            >

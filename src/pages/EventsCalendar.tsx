...
const EventsCalendar = () => {
  ...
  return (
    <div className="min-h-screen bg-trailflow-white relative">
      {/* Polymer-style background with dark gray tone */}
      <div 
        className="fixed inset-0 w-full h-full opacity-5 pointer-events-none z-0"
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1527576539890-dfa815648363?auto=format&fit=crop&w=3994&q=80')`,
      ...
      {/* Dark gradient overlay for polymer effect */}
      <div className="fixed inset-0 w-full h-full pointer-events-none z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900/10 via-gray-800/5 to-gray-900/15"></div>
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-bl from-gray-700/5 to-transparent"></div>
        <div className="absolute bottom-0 left-0 w-1/2 h-full bg-gradient-to-tr from-gray-800/5 to-transparent"></div>
      </div>

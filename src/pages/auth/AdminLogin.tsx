            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className="w-full p-3 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
                    placeholder="••••••••"
                    required
                    disabled={isLoading}
                  />
              ...
              <div className="flex items-center justify-end">
                <button
                  ...
                  className="text-sm text-red-600 hover:text-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 rounded transition-colors"
                  disabled={isLoading}
                >
                  Esqueceu a senha?
                </button>
